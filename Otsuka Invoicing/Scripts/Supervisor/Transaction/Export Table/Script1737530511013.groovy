...
WebUI.click(findTestObject('Transaction/Approval/Export Table/Page_Approval/Button Export Excel'))

WebUI.click(findTestObject('Transaction/Approval/Export Table/Page_Approval/Button Export PDF'))

WebUI.click(findTestObject('Transaction/Approval/Export Table/Page_Approval/Button Print'))
