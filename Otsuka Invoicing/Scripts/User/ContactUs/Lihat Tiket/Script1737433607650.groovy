...
WebUI.click(findTestObject('Contact Us/Lihat_Ticket/Lihat Ticket'), FailureHandling.OPTIONAL)

WebUI.delay(3, FailureHandling.OPTIONAL)

WebUI.click(findTestObject('Contact Us/Lihat_Ticket/Close Lihat Ticket'), FailureHandling.OPTIONAL)
