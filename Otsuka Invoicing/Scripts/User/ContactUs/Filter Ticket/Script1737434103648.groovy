...
WebUI.click(findTestObject('Contact Us/Filter_Ticket/Filter'), FailureHandling.OPTIONAL)

// Randomize open or close button
Random rand = new Random()

int randomChoice = rand.nextInt(2 // Generate random number (0 or 1)
    )

if (randomChoice == 0) {
    WebUI.click(findTestObject('Contact Us/Filter_Ticket/open' // Open button
            ) // Close button
        )
} else {
    WebUI.click(findTestObject('Contact Us/Filter_Ticket/close'))
}

WebUI.delay(1, FailureHandling.OPTIONAL)

WebUI.click(findTestObject('Contact Us/Filter_Ticket/Submit Filter'), FailureHandling.OPTIONAL)
