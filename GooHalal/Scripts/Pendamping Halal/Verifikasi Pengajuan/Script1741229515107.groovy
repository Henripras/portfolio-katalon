...
// Daftar nomor HP
def phoneNumbers = ['081279699119', '081221581491', '081239289400', '081213996906', '081214752282', '081210328641', '081291617353']
...
clickWithOptionalHandling(findTestObject('Pendamping Halal/Page Dashboard Verifikasi Pengajuan/Button Lihat'))

clickWithOptionalHandling(findTestObject('Pendamping Halal/Page Dashboard Verifikasi Pengajuan/Page Verifikasi Pengajuan/Button Mengerti Pop Up'))

WebUI.scrollToElement(findTestObject('Pendamping Halal/Page Dashboard Verifikasi Pengajuan/Page Verifikasi Pengajuan/Label Video Kunjungan'), 
    3)

clickWithOptionalHandling(findTestObject('Pendamping Halal/Page Dashboard Verifikasi Pengajuan/Page Verifikasi Pengajuan/Button Rekam Video'))

clickWithOptionalHandling(findTestObject('Pendamping Halal/Page Dashboard Verifikasi Pengajuan/Page Verifikasi Pengajuan/Button Mengerti Pop Up'))

clickWithOptionalHandling(findTestObject('Pendamping Halal/Page Dashboard Verifikasi Pengajuan/Page Verifikasi Pengajuan/Button File Perangkat Video'))

WebUI.delay(10)

clickWithOptionalHandling(findTestObject('Pendamping Halal/Page Dashboard Verifikasi Pengajuan/Page Verifikasi Pengajuan/Button Kirim'))

clickWithOptionalHandling(findTestObject('Pendamping Halal/Page Dashboard Verifikasi Pengajuan/Page Surat Pernyataan Pendamping Halal/Button Checkbox'))

clickWithOptionalHandling(findTestObject('Pendamping Halal/Page Dashboard Verifikasi Pengajuan/Page Surat Pernyataan Pendamping Halal/Button Kirim Pengajuan'))
