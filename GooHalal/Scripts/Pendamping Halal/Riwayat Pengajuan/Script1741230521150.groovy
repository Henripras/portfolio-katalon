...
WebUI.setText(findTestObject('Login/Field Email Login'), '081296913674')
...
WebUI.click(findTestObject('Pendamping Halal/Homepage/Sub Menu Riwayat Pengajuan'))

WebUI.click(findTestObject('Pendamping Halal/Homepage/Button Lihat Riwayat Pengajuan'))

WebUI.delay(2)

WebUI.click(findTestObject('Pendamping Halal/Homepage/Button Kembali'))
