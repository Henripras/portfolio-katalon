...
WebUI.click(findTestObject('Komite Fatwa/Homepage/Menu Pengajuan Baru'))

WebUI.click(findTestObject('Komite Fatwa/Page Pengajuan Baru/Button Terima Pengajuan Baru'))
