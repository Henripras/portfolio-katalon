...
WebUI.click(findTestObject('Komite Fatwa/Homepage/Sub Menu Riwayat Penetapan Halal'))

WebUI.click(findTestObject('Komite Fatwa/Page Riwayat Penetapan Halal/Button Lihat Detail'))
