...
for (int i = 1; i <= GlobalVariable.maxLoop; i++) {
    ...
    // Memanggil test case Edit Akun Bank
    WebUI.callTestCase(findTestCase('Test Cases/Master Data/Admin Sekolah/Master Data Akun Bank/Edit Akun Bank'), [:] // Kosongkan map jika tidak ada parameter
        , FailureHandling.CONTINUE_ON_FAILURE)
