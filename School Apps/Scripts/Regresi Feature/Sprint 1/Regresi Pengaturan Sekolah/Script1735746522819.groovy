...
for (int i = 1; i <= GlobalVariable.maxLoop; i++) {
    ...
    // Memanggil test case Edit Sekolah
    WebUI.callTestCase(findTestCase('Test Cases/Master Data/Super Admin/Master Data Sekolah/Edit Sekolah'), [:] // Kosongkan map jika tidak ada parameter
        , FailureHandling.OPTIONAL)
