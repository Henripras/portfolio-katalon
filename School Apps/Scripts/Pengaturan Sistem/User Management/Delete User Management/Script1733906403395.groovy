...
WebUI.click(findTestObject('Pengaturan Sistem/User Managemet/Delete User Management/Tridot Action'))

WebUI.click(findTestObject('Pengaturan Sistem/User Managemet/Delete User Management/Hapus'))

WebUI.click(findTestObject('Pengaturan Sistem/User Managemet/Delete User Management/Button YA popup'))
