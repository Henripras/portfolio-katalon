...
WebUI.click(findTestObject('Pengaturan Sistem/User Managemet/Filter User Management/Dropdown Status'))

WebUI.click(findTestObject('Pengaturan Sistem/User Managemet/Filter User Management/Status Aktif'))
