...
WebUI.click(findTestObject('Laporan/Laporan Pembayaran/Lihat Detail Laporan Pembayaran/Button Lihat Detail'))

WebUI.verifyElementVisible(findTestObject('Laporan/Laporan Pembayaran/Lihat Detail Laporan Pembayaran/Button Cetak'))

WebUI.click(findTestObject('Laporan/Laporan Pembayaran/Lihat Detail Laporan Pembayaran/Button Cetak'))
