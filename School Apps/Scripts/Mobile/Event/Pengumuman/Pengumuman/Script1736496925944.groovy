...
Mobile.tap(findTestObject('Mobile/Event dan Pengumuman/Pengumuman/Button Pengumuman'), 0)

Mobile.tap(findTestObject('Mobile/Event dan Pengumuman/Pengumuman/card pengumuman'), 0)
