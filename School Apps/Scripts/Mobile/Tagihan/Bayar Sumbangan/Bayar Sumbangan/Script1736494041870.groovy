...
Mobile.tap(findTestObject('Mobile/Tagihan/Tombol Tagihan'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.tap(findTestObject('Mobile/Sumbangan/Card Sumbangan'), 0)

Mobile.tap(findTestObject('Mobile/Sumbangan/Button Bayar Sumbangan'), 0)

Mobile.tap(findTestObject('Mobile/Sumbangan/Masukkan Nominal Uang'), 0)

Mobile.setText(findTestObject('Mobile/Sumbangan/Masukkan Nominal Uang'), '90000', 0)

Mobile.tap(findTestObject('Mobile/Sumbangan/Tombol Lanjutkan'), 0)

Mobile.tap(findTestObject('Mobile/Sumbangan/Bullet Pembayaran'), 0)

Mobile.tap(findTestObject('Mobile/Sumbangan/Button Bayar Sumbangan'), 0)

Mobile.tap(findTestObject('Mobile/Tagihan/Arrow Pembayaran'), 0)

Mobile.tap(findTestObject('Mobile/Tagihan/Card Riwayat Pembayaran'), 0)
