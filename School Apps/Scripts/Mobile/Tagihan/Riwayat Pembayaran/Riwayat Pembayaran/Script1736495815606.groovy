...
Mobile.startApplication('C:\\Users\\akmal\\Downloads\\app-sit-debug.apk', false)
...
'\r\n'
Mobile.tap(findTestObject('Mobile/Login/Tombol Masuk'), 0, FailureHandling.OPTIONAL)

Mobile.delay(3, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Mobile/Tagihan/Tombol Tagihan'), 0)
