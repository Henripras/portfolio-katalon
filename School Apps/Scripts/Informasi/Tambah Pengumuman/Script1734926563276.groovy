...
WebUI.click(findTestObject('Informasi/Tambah Pengumuman/Button Tambah'))

WebUI.click(findTestObject('Informasi/Tambah Pengumuman/Input Judul'))

WebUI.setText(findTestObject('Informasi/Tambah Pengumuman/Input Judul'), 'Katalons')

WebUI.click(findTestObject('Informasi/Tambah Pengumuman/Input Deskripsi'))

WebUI.setText(findTestObject('Informasi/Tambah Pengumuman/Input Deskripsi'), 'Jaldi')

WebUI.click(findTestObject('Informasi/Tambah Pengumuman/Button Simpan'))

WebUI.click(findTestObject('Informasi/Tambah Pengumuman/Button Ya'))
