...
WebUI.click(findTestObject('Master Data/TU/Akun Bank/Delete Akun Bank/Button Hapus'))

WebUI.click(findTestObject('Master Data/TU/Akun Bank/Delete Akun Bank/Klik YA'))
