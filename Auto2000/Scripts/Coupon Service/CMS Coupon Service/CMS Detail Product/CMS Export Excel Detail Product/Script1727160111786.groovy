...
WebUI.click(findTestObject('Coupon Service/CMS Coupon Service/CMS Detail Product/Data Export Excell'))

WebUI.delay(2)

WebUI.click(findTestObject('Coupon Service/CMS Coupon Service/CMS Detail Product/Button Yes Export'))
