...
WebUI.click(findTestObject('Coupon Service/CMS Coupon Service/CMS FAQ/Dashboard Detail FAQ/Button Publish'))

WebUI.click(findTestObject('Coupon Service/CMS Coupon Service/CMS FAQ/Export Excel/Button Ya'))

WebUI.delay(4)

WebUI.click(findTestObject('Coupon Service/CMS Coupon Service/CMS FAQ/Dashboard Detail FAQ/Button Delete'))
