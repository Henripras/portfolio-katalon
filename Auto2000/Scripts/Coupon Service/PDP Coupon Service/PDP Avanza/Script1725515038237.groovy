...
WebUI.click(findTestObject('Coupon Service/PDP Coupon Service/Model Avanza'))

WebUI.delay(5)

WebUI.click(findTestObject('Coupon Service/PDP Coupon Service/Card Cuopon Avanza'))
...
WebUI.click(findTestObject('Coupon Service/PDP Coupon Service/Cuopon Servis Avanza'))

WebUI.delay(2)

WebUI.scrollToPosition(0, 153)

WebUI.click(findTestObject('Coupon Service/PDP Coupon Service/Cuopon Servis Avanza 2'))

WebUI.delay(2)

//WebUI.scrollToPosition(0, 452)

//WebUI.click(findTestObject('Coupon Service/PDP Coupon Service/Cuopon Servis Avanza 3'))
