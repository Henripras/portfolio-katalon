...
WebUI.click(findTestObject('Coupon Service/PDP Coupon Service/Model Innova'))

WebUI.delay(5)

WebUI.click(findTestObject('Coupon Service/PDP Coupon Service/Cuopon Servis Innova'))
...
WebUI.click(findTestObject('Coupon Service/PDP Coupon Service/Otomatis Innova'))

WebUI.delay(2)

WebUI.scrollToPosition(0, 153)

WebUI.click(findTestObject('Coupon Service/PDP Coupon Service/Cuopon Servis Innova 1'))

WebUI.delay(2)

WebUI.scrollToPosition(0, 440)

WebUI.click(findTestObject('Coupon Service/PDP Coupon Service/Cuopon Servis Innova 2'))
