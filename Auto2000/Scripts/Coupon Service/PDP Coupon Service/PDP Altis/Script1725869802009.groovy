...
WebUI.click(findTestObject('Coupon Service/PDP Coupon Service/Model Altis'))

WebUI.delay(5)

WebUI.click(findTestObject('Coupon Service/PDP Coupon Service/Card Cuopon Altis'))
...
WebUI.verifyElementVisible(findTestObject('Coupon Service/PDP Coupon Service/Tipe Otomatis Altis'))

WebUI.delay(2)

WebUI.click(findTestObject('Coupon Service/PDP Coupon Service/Otomatis Altis'))

WebUI.delay(2)

WebUI.scrollToPosition(0, 153)

WebUI.click(findTestObject('Coupon Service/PDP Coupon Service/Coupon Servis Altis'))
