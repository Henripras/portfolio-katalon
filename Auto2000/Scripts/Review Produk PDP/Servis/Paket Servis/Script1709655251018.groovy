...
WebUI.navigateToUrl('https://pre.auto2000.co.id/review-produk/paket-servis-auto-2000')

WebUI.maximizeWindow()

WebUI.verifyElementVisible(findTestObject('Object Review Produk/Review Produk/PDP Review Produk/Servis/Paket Servis/Offering card paket servis'))

WebUI.click(findTestObject('Object Review Produk/Review Produk/PDP Review Produk/Servis/Paket Servis/offCard pktservis/button_LIHAT PAKET SERVIS LAINNYA'))
...
WebUI.verifyElementVisible(findTestObject('Object Review Produk/Review Produk/PDP Review Produk/Servis/Paket Servis/Detail konten'))
