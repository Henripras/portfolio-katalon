...
while ((retryCount < maxRetry) && !(elementFound)) {
    try {
        ...
        WebUI.setText(findTestObject('Object Repository/Landing Page/City Landing Page/Inquiry Mobil baru promo city/Page_CICILAN RINGAN MOBIL TOYOTA AGYA  Auto 2000/inputinput-full-name'), 
            'komar')

        WebUI.setText(findTestObject('Object Repository/Landing Page/City Landing Page/Inquiry Mobil baru promo city/Page_CICILAN RINGAN MOBIL TOYOTA AGYA  Auto 2000/inputinput-phone-number'), 
            '85819486322')

        WebUI.click(findTestObject('Object Repository/Landing Page/City Landing Page/Inquiry Mobil baru promo city/Page_CICILAN RINGAN MOBIL TOYOTA AGYA  Auto 2000/inputdd-model-mobil'))
