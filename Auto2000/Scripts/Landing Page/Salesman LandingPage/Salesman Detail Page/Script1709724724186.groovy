...
//WebUI.click(findTestObject('Share Sosmed'))
//WebUI.click(findTestObject('Salesman Object/Whatshap'))
//
//WebUI.delay(5)
//
//WebUI.click(findTestObject('Salesman Object/Facebook'))
//
//WebUI.delay(5)
//
//WebUI.click(findTestObject('Salesman Object/Twitter'))
//
//WebUI.delay(5)
//
//WebUI.click(findTestObject('Salesman Object/Tiktok'))
WebUI.delay(5)

WebUI.switchToWindowUrl('https://pre.auto2000.co.id/dealer-toyota/jakarta-pusat/auto2000cempakaputih/sales-advisor/riza-adrialdi-00021068')

WebUI.click(findTestObject('Salesman Object/Button Close'))
