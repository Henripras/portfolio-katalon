...
WebUI.scrollToElement(findTestObject('NCP/PDP NCP/INTERIOR/News/Scroll Position'), 0)

WebUI.click(findTestObject('NCP/PDP NCP/INTERIOR/News/Lihat Semua News'))
...
WebUI.click(findTestObject('NCP/PDP NCP/OVERVIEW/News/Detail Card/Model Mobil'))
	...
	//Isi Model Mobil
	if (WebUI.verifyElementPresent(findTestObject('NCP/PDP NCP/OVERVIEW/News/Detail Card/Isi Model Mobil'),
