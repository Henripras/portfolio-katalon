...
WebUI.scrollToElement(findTestObject('NCP/PDP NCP/INTERIOR/Promo/Scroll Position'), 0)

WebUI.click(findTestObject('NCP/PDP NCP/INTERIOR/Promo/Lihat Semua Promo'))

WebUI.waitForPageLoad(2)

WebUI.doubleClick(findTestObject('NCP/PDP NCP/INTERIOR/Promo/Listing Promo/Scroll Ke Bawah'))
