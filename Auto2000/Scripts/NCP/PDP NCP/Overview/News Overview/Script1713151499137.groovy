...
WebUI.scrollToPosition(0, 3600)

// Verifikasi bahwa elemen 'Lihat Semua Overview News' ada dan terlihat sebelum diklik
boolean isElementPresentBeforeClick = WebUI.verifyElementPresent(findTestObject('NCP/PDP NCP/OVERVIEW/News/Lihat Semua Overview News'), 
    30)

boolean isElementVisibleBeforeClick = WebUI.verifyElementVisible(findTestObject('NCP/PDP NCP/OVERVIEW/News/Lihat Semua Overview News'))

if (isElementPresentBeforeClick && isElementVisibleBeforeClick) {
    // Jika elemen ada dan terlihat, klik pada elemen 'Lihat Semua Overview News'
    WebUI.click(findTestObject('NCP/PDP NCP/OVERVIEW/News/Lihat Semua Overview News'))

    // Tunggu hingga halaman selesai dimuat
    WebUI.waitForPageLoad(10)

    // Tunggu beberapa detik untuk memastikan elemen target muncul
    WebUI.delay(3)

    // Verifikasi bahwa elemen target berikutnya hadir setelah klik
    boolean isElementPresentAfterClick = WebUI.verifyElementPresent(findTestObject('NCP/PDP NCP/OVERVIEW/News/Target Element Setelah Klik'), 
        30, FailureHandling.OPTIONAL)
} else {
    WebUI.comment('Elemen "Lihat Semua Overview News" tidak ditemukan atau tidak terlihat sebelum diklik.')
}
...
if (WebUI.verifyElementPresent(findTestObject('Object Repository/Promosi Nasional/Promo Semua/Section Inquiry Form'), 10, 
    ...
    //Ceklis Checkbox
    WebUI.click(findTestObject('Promosi Nasional/Promo Semua/Minta Penawaran Semua/Checkbox'), FailureHandling.OPTIONAL // Jika Inquiry Form ada, lanjut ke langkah selanjutnya
        // Jika Inquiry Form tidak ada, kembali ke halaman sebelumnya
        //Isi Model Mobil
        // Step 2: If the element exists, click on it
